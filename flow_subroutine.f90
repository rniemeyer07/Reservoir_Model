...
implicit none
 ...
 ! integer :: year, month, day
      ...
      !-------------- measured releases (penstock and spillway) ---------------
        ...
        flow_out_hyp_x = Q_pen * ftsec_to_msec ! converts ft^3/sec to m^3/day
        flow_out_epi_x = Q_spill * ftsec_to_msec ! converts ft^3/sec to m^3/day
      ...
      !      ,  headw_T_out, air_T
       ...
       !  flow_out_hyp_x = Q_out * prcnt_flow_epil
       !  flow_out_epi_x = Q_out * prcnt_flow_hypo
