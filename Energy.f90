SUBROUTINE surf_energy(stream_T_in,q_surf,ncell)
   ...
   implicit none
   integer::i,ncell,nd
   real::A,B,T_equil,e0,q_surf,q_conv,q_evap,q_ws,td,stream_T_in
...
!
   ...
   T_equil = (0 - B) / A  ! equilibrium temperature - set temp to 0, solve for T

    write(31,*) e0, rb, pf, lvp,evap_coeff,wind(ncell), stream_T_in, q_surf, q_fit(1), q_fit(2)  &
               , q_ns(1), q_na(1), q_ws, q_evap, q_conv, T_equil
