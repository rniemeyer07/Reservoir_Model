...
real :: volume_e_x, volume_h_x, T_epil_temp, T_hypo_temp, energy_x2
  ...
  ! --------------------- calculate advection terms --------------------------- 
         advec_in_epix  = flow_in_epi_x * (stream_T_in - T_epil_temp)
         advec_epi_hyp = flow_epi_hyp_x *  (T_epil_temp - T_hypo_temp)
         advec_in_hypx = flow_in_hyp_x * (stream_T_in - T_hypo_temp) 
  ...
  ! ------------------- calculate change in temperature  ---------------------
      ! ---------------- epilimnion -----------
         ! ------------ calculate total energy ----------
          ...
          temp_change_ep = advec_in_epix -  dif_epi_x + energy_x ! - advec_out_epix - dV_dt_epi
